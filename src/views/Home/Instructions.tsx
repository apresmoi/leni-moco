  ...
  return (
    ...
    >
      ...
      <rect
        ...
        rx="37"
      ></rect>
        <path onClick={() => history.push('/play')} d="M783.58 71 795 59.63a3.57 3.57 0 0 0 0-5.06l-2.52-2.52a3.57 3.57 0 0 0-5.06 0L776 63.42l-11.37-11.37a3.57 3.57 0 0 0-5.06 0l-2.52 2.52a3.57 3.57 0 0 0 0 5.06L768.42 71l-11.37 11.37a3.57 3.57 0 0 0 0 5.06l2.52 2.57a3.57 3.57 0 0 0 5.06 0L776 78.58 787.37 90a3.57 3.57 0 0 0 5.06 0l2.57-2.57a3.57 3.57 0 0 0 0-5.06Z" fill="#646119"/>
      <rect
        width="722"
        height="389"
        x="65"
