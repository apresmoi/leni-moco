...
" */
  switch(element){
    case "fire":
      return(<text   className="description-text" >                 
      <tspan x={60} y={490}>fiery small and hot ball of  </tspan> 
      <tspan x={60} y={515}>condensed fire. </tspan>
      <tspan x={60} y={565}>Skill: He’s so hot that it makes </tspan> 
      <tspan x={60} y={590}>ice walls melt.</tspan>
      <tspan x={60} y={615}>Immune to: Lava pools.</tspan>
   </text>);
    case "water":
      return(
        <text   className="description-text" >                 
          <tspan x={60} y={490}>Water, do you know it kiddos?</tspan> 
          <tspan x={60} y={510}>It's cool and fresh. </tspan>
          <tspan x={60} y={555}>Skill: Turns lava pools into</tspan> 
          <tspan x={60} y={575}>stone floors with the fresh </tspan> 
          <tspan x={60} y={595}>power of H2O. Immune to: </tspan>
          <tspan x={60} y={630}>Water pools, like the cool kids.</tspan>
          <tspan x={60} y={645}>Vulnerable against: Ice walls,</tspan>  
          <tspan x={60} y={665}>thirsty creatures </tspan> 
          <tspan x={60} y={685}>and Game Jammers.</tspan>  
        </text>);
      case "darkness":
         return (<text   className="description-text" >                 
          <tspan x={60} y={490}>A solid round piece of shady </tspan> 
          <tspan x={60} y={515}>shadow, born from oblivion and </tspan>
          <tspan x={60} y={535}>always on the watch. </tspan>
          <tspan x={60} y={565}>Skill: Merges with Shadow walls</tspan> 
          <tspan x={60} y={590}>and pass through the Immune to: </tspan> 
          <tspan x={60} y={615}>Smoke and naive super heroes</tspan>
          <tspan x={60} y={635}>who can't deal with his shadiness.</tspan>
          <tspan x={60} y={665}>Vulnerable against: Lava pools.</tspan>   
         </text>);
  }
}
                  ...
                  {game?.inventory?.rightSlime && (
                    ...
                    />
                      ...
                      <g className=".lime-container">
                          <Slime idx="inv01" x={365} y={360} color="fire"  onClick={handleSlimeClick} />
                          <Slime idx="inv02" x={465} y={360} color="water" onClick={handleSlimeClick} />
                          <Slime idx="inv03" x={565} y={360} color="darkness" onClick={handleSlimeClick} />
                      </g> 
